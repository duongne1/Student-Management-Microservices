...
// http://localhost:3003/api/v1/feedBacks/getAllFeedBack
router.get("/getAllFeedBack", feedBackController.getAllFeedBack);
// http://localhost:3003/api/v1/feedBacks/getFeedBackByID/
...
// http://localhost:3003/api/v1/feedBacks/getFeedBackByCourseID/
router.get(
  "/getFeedBackByCourseID/:courseId",
  feedBackController.getFeedBackByCourseID
);
// http://localhost:3003/api/v1/feedBacks/addFeedBack
